      ...
      <div className="container mx-auto px-4 py-12">
        <header className="text-center mb-16">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            High-performance multiplication calculator powered by Rust backend with modern React frontend
          </p>
        </header>
            ...
            <div className="flex items-center justify-center gap-3 mb-3">
              <div className="flex items-center gap-2">
                <svg className="w-4 h-4 text-orange-500" fill="currentColor" viewBox="0 0 24 24">
                  <path d="M23.15 2.587L18.21.21a1.494 1.494 0 0 0-1.705.29l-9.46 8.63-4.12-3.128a.999.999 0 0 0-1.276.057L.327 7.261A1 1 0 0 0 .326 8.74L3.899 12 .326 15.26a1 1 0 0 0 .001 1.479L1.65 17.94a.999.999 0 0 0 1.276.057l4.12-3.128 9.46 8.63a1.492 1.492 0 0 0 1.704.29l4.942-2.377A1.5 1.5 0 0 0 23.15 2.587z"/>
                </svg>
                <span className="text-sm font-medium text-foreground">Rust Backend</span>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm font-medium text-foreground">React Frontend</span>
              </div>
            </div>
